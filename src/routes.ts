...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/todo',
            ...
            function TodoController_create(request: any, response: any, next: any) {
            const args = {
        ...
        app.put('/todo/:id',
            ...
            function TodoController_update(request: any, response: any, next: any) {
            const args = {
        ...
        app.delete('/todo/:id',
            ...
            function TodoController_remove(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
